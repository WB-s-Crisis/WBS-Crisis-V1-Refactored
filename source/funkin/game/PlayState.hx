...
class PlayState extends MusicBeatState
{
	...
	@:dox(hide) override public function create()
	{
		...
		healthBar = new FlxBar(healthBarBG.x + healthBarOffset.x, healthBarBG.y + healthBarOffset.y, RIGHT_TO_LEFT, Std.int(healthBarBG.width - healthBarOffset.width), Std.int(healthBarBG.height - healthBarOffset.height), (scripts.publicVariables.exists("healthBarDirection") && Reflect.isObject(scripts.publicVariables["healthBarDirection"]) ? scripts.publicVariables["healthBarDirection"] : this),
			...
			(scripts.publicVariables.exists("healthBarDirection") && Reflect.isObject(scripts.publicVariables["healthBarDirection"]) && Reflect.getProperty(scripts.publicVariables["healthBarDirection"], "min") != null ? Reflect.getProperty(scripts.publicVariables["healthBarDirection"], "min") : 0),
			(scripts.publicVariables.exists("healthBarDirection") && Reflect.isObject(scripts.publicVariables["healthBarDirection"]) && Reflect.getProperty(scripts.publicVariables["healthBarDirection"], "max") != null ? Reflect.getProperty(scripts.publicVariables["healthBarDirection"], "max") : maxHealth));
