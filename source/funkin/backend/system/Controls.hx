...
class Controls extends FlxActionSet
{
	...
	inline function get_DODGE_P():Bool {
		return _dodgeP.check() #if TOUCH_CONTROLS || mobileControlsJustPressed(MobileInputID.EXTRA_1) #end;
	}
	
	public var DODGE(get, never):Bool;
	inline function get_DODGE():Bool {
		return _dodge.check() #if TOUCH_CONTROLS || mobileControlsPressed(MobileInputID.EXTRA_1) #end;
	}
	
	public var DODGE_R(get, never):Bool;
	inline function get_DODGE_R():Bool {
		return _dodgeR.check() #if TOUCH_CONTROLS || mobileControlsJustReleased(MobileInputID.EXTRA_1) #end;
	}
	...
	public function mobileControlsJustPressed(id:MobileInputID):Bool
	{
		...
		if (state != null)
		{
			...
			else if(state.virtualPad != null)
				bools[1] = state.virtualPad.instance.buttonJustPressed(id);
		}
		...
		if (substate != null)
		{
			...
			else if(substate.virtualPad != null)
				bools[1] = substate.virtualPad.instance.buttonJustPressed(id);
		}
	...
	public function mobileControlsJustReleased(id:MobileInputID):Bool
	{
		...
		if (state != null)
		{
			...
			if (state.hitbox != null)
				...
				bools[1] = state.virtualPad.instance.buttonJustReleased(id);
		}
		...
		if (substate != null)
		{
			...
			if (substate.virtualPad != null)
				bools[3] = substate.virtualPad.instance.buttonJustReleased(id);
		}
	...
	public function mobileControlsPressed(id:MobileInputID):Bool
	{
		...
		if (state != null)
		{
			...
			if (state.hitbox != null)
				...
				bools[1] = state.virtualPad.instance.buttonPressed(id);
		}
		...
		if (substate != null)
		{
			...
			if (substate.hitbox != null)
				...
				bools[3] = substate.virtualPad.instance.buttonPressed(id);
		}
	...
	public function mobileControlsReleased(id:MobileInputID):Bool
	{
		...
		if (state != null)
		{
			...
			if (state.hitbox != null)
				...
				bools[1] = state.virtualPad.instance.buttonReleased(id);
		}
		...
		if (substate != null)
		{
			...
			if (substate.hitbox != null)
				...
				bools[3] = substate.virtualPad.instance.buttonReleased(id);
		}
